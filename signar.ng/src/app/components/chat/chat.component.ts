...
export class ChatComponent  {
  ...
  deleteChannel(channel: Channel){
    // TODO: Ajouter un invoke
    this.hubConnection!.invoke('DeleteChannel', channel.id); ///D'où provient le DeleteChannel ??? Méthode du serveur ? Lorsque invoke = méthode serveur et hubConnection.on = message envoyé dans le serveur ?
  }
